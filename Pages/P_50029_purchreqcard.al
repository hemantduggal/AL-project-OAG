page 50029 "PurchRequisitionCard"
{
    ...
    layout
    {
        area(Content)
        {
            ...
            {
                Caption = 'Lines';
                part(PurchRequisitionLine; "PurchRequisitionSubForm")
                {
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(Issued)
            {
                ...
                trigger OnAction()
                var
                    ReqL: Record "purchase requisition line";
                    ...
                    ReqL1: Record "purchase requisition line";
                ...
                begin
                    ...
                    IF ReqL.FINDSET THEN
                        REPEAT
                            ...
                            IssueCode.PostpurchRequistion(Rec, ReqL);
                            flag := true;
                        UNTIL ReqL.NEXT = 0;
                    if flag = false then
                    ...
                    begin
                        if Rec.Status = Rec.Status::Open then begin
                            ...
                            if user.get(Rec."1st Approved/Rejected User ID") then
                                smtp.sendmail('Purchase Req: ', rec."Requisition Slip No.", UserId, '', '', user."E-Mail", 'Please approve This Purchase requistion :' + Rec."Requisition Slip No.");
                            user.Reset();
