page 50056 RequisitionListFA
{
    PageType = List;
    Caption = 'FA Requisition List';
    UsageCategory = Administration;
    ApplicationArea = all;
    SourceTable = "Requisition Header FA";
    CardPageId = "RequisitionCardFA";
    Editable = false;
    SourceTableView = sorting("Requisition Slip No.") order(descending) where(Status = filter(Open | "Pending for Approval"));
