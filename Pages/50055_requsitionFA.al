page 50055 "RequisitionCardFA"
{
    Caption = 'Requisition Card FA';
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            ...
            {
                Caption = 'Lines';
                part(RequisitionLine; "RequisitionSubFormFA")
                {
                ...
                begin
                    ...
                    if reqhead.FindFirst() then begin
                        if Rec."1st Approved/Rejected User ID" = UserId then begin
                            Rec.TestField("1st Reject Comment");
                        ...
                        if Rec."2nd Approved/Rejected User ID" = UserId then begin
                            if rec."1st Reject Comment" = '' then
                                Error('1st approval is required');
                            rec.TestField("1st Reject Comment");
                            Rec.TestField("1st Reject Comment");
                            Rec.TestField("2nd Reject Comment");
