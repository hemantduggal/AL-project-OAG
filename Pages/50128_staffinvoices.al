page 50128 "staff Invoices"
{
    AdditionalSearchTerms = 'Staff invoice';
    ApplicationArea = Basic, Suite;
    Caption = 'Staff Invoices';
    ...
    SourceTableView = WHERE("Document Type" = CONST(Invoice), "Vendor Type" = filter(Staff));
    UsageCategory = Lists;
