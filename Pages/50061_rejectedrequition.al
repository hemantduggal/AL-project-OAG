page 50062 rejectedRequisitionList
{
    PageType = List;
    Caption = 'Rejected Store Requisition List';
    UsageCategory = Administration;
    ApplicationArea = all;
    SourceTable = "Requisition Header";
    CardPageId = "RequisitionCard";
    Editable = false;
    SourceTableView = sorting("Requisition Slip No.") order(descending) where(Status = filter(Rejected));
