codeunit 50004 WHTManagement
{
    ...
    var
        ...
        DocType: Option " ",Payment,Invoice,"Credit Memo","Finance Charge Memo",Reminder,Refund;//Enum "Gen. Journal Document Type";
        ...
        ApplyDocType: Option " ",Payment,Invoice,"Credit Memo","Finance Charge Memo",Reminder,Refund;//Enum "Gen. Journal Document Type";
        ApplyDocNo: Code[20];
        TotAmt: Decimal;
        NextEntry: Integer;
        TempRemBase: Decimal;
    ...
    begin
        ...
        if TempVendLedgEntry.FindSet() then
            repeat
                ...
                PmtDiscount := 0;
                if CheckPmtDisc(GenJnlLine."Posting Date", TempVendLedgEntry."Pmt. Discount Date",
    ...
    procedure SetVendAppliesToFilter(var VendLedgEntry: Record "Vendor Ledger Entry"; GenJnlLine: Record "Gen. Journal Line")
    begin
    ...
    var
        ...
        WHTPart: Decimal;
    begin
        // Message('%1..%2', WHTBusPostGrp, WHTProdPostGrp);
    ...
    begin
        // Message('%1...%2', Abs(TotalInvoiceAmountLCY), WHTPostingSetup."WHT Minimum Invoice Amount");
    ...
    local procedure FindWHTEntryForApply(var WHTEntry: Record "WHT Entry"; DocType: Enum "Gen. Journal Document Type"; DocNo: Code[20];
                                                                                        WHTBusPostingGr: Code[20];
                                                                                        WHTProdPostingGr: Code[20]): Boolean
    begin
        WHTEntry.Reset();
