table 50014 "purchase Requisition Header"
{
        ...
        field(1; "Requisition Slip No."; Code[20])
        {
            ...
            begin
                IF "Requisition Slip No." <> xRec."Requisition Slip No." THEN BEGIN
                    PurchSetup.GET;
                    NoSeriesMgt.TestManual(PurchSetup."Purch. Requisition");
                    "No. Series" := '';
                END;
    ...
    begin
        PurchSetup.GET;
        PurchSetup.TESTFIELD(PurchSetup."Purch. Requisition");
        IF "Requisition Slip No." = '' THEN BEGIN
            NoSeriesMgt.InitSeries(PurchSetup."Purch. Requisition", xRec."No. Series", 0D, "Requisition Slip No.", "No. Series");
        END;
    ...
    begin
        PurchSetup.GET;
        PurchSetup.TESTFIELD("Purch. Requisition");
        EXIT(PurchSetup."Purch. Requisition");
    ...
    procedure AssistEdit(RequistionHeader: Record "purchase Requisition Header"): Boolean
    var
        myInt: Integer;
    begin
