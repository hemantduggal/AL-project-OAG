tableextension 50005 PurcReceiptHeaderExt extends "Purch. Rcpt. Header"
{
    fields
    {
        ...
        field(50003; "Details T&C (Attach)"; text[250])
        {
            DataClassification = ToBeClassified;
            Caption = 'Details T&C (Attach)';
        }
        field(50004; "General T&C"; text[250])
        {
            DataClassification = ToBeClassified;
            Caption = 'General T&C';
        }
        field(50005; "Special T&C "; text[250])
        {
            DataClassification = ToBeClassified;
            Caption = 'Special T&C ';
        }
        ...
        field(50023; "Store Admin User ID"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        //  field(50024; "Store_Date"; Date)
        //  {
        //     DataClassification = ToBeClassified;
        //  }
        field(50025; "Contract Manager User ID"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        //   field(50026; "ContractManager_Date"; Date)
        //  {
        //      DataClassification = ToBeClassified;
        //  }
        field(50027; "Internal Auditor User ID"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        // field(50028; "InternalAuditor_Date"; Date)
        // {
        //     DataClassification = ToBeClassified;
        // }
