report 50002 "GRN Report"
{
    UsageCategory = Administration;
    ApplicationArea = All;
    Caption = 'GRN Report';
    DefaultLayout = RDLC;
    RDLCLayout = 'ReportLayout\Extended_PurchaseReceipt.rdl';
    //'ReportLayout\GRNReport.rdl';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            //////new columns added by Neha
            column(storeadmin; "Store Admin User ID")
            {

            }
            column(Store_Visual_Date; "Store_Visual Date")
            {

            }
            column(Contract_Manager_User_ID; "Contract Manager User ID")
            {

            }
            column(Contract_Visual_Date; "Contract_Visual Date")
            {

            }
            column(Internal_Auditor_User_ID; "Internal Auditor User ID")
            {

            }
            column(Internal_Visual_Date; "Internal_Visual Date")
            {
    ...
    begin
        CompanyInfo.Get();
        CompanyInfo.CALCFIELDS(CompanyInfo.Picture);///neha
        OnAfterInitReport;
    end;
